...
const SKILLS = [
  ...
  { name: "PHP", color: "#777BB4", path: "M12 5C6.5 5 2 8.1 2 12s4.5 7 10 7 10-3.1 10-7-4.5-7-10-7Zm-6.7 9.6H4l.8-4.2h2c1.2 0 1.7.6 1.5 1.6-.2 1.4-1.2 2-2.6 2H4.9l-.4 1.6h.8Zm5.5-1.6h-1.8l-.4 1.6h-1.2l.9-4.2h2c1.1 0 1.7.4 1.5 1.4-.2 1-.9 1.2-2 1.2Zm5.7 0H15l-.3 1.6h-1.3l.9-4.2h1.3l-.3 1.5h1.7l.3-1.5h1.3l-.9 4.2h-1.3l.3-1.6Z" },
  { name: "JavaScript", color: "#F7DF1E", path: "M4 3h16v18H4V3Zm8.5 13c0 1 .5 1.7 1.6 1.7s1.7-.5 1.7-2v-5h1.6v5c0 2-.9 3.4-3.3 3.4-2 0-3.3-1.1-3.3-3.1h1.7Zm-4.7-.1c.2.9.8 1.6 1.9 1.6.9 0 1.4-.5 1.4-1.1 0-.7-.4-1-1.5-1.4l-.6-.3c-1.7-.7-2.7-1.6-2.7-3.2 0-1.5 1.1-2.7 2.9-2.7 1.3 0 2.2.5 2.8 1.7l-1.5.9c-.3-.6-.6-.8-1.3-.8s-1.1.4-1.1.9c0 .6.4.9 1.4 1.3l.6.3c2 .9 3 1.7 3 3.4 0 1.8-1.4 2.8-3.3 2.8-1.9 0-3-.9-3.6-2.1l1.6-.9Z" },
];
